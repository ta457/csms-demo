        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-700 dark:bg-gray-900">
            <div>
                <a href="/" class="flex items-center gap-2">
                    <x-application-logo class="w-16 h-16 fill-current text-gray-200" />
                    <p class="text-gray-200 text-6xl">
                        CSMS
                    </p>
                </a>
                <p class="text-gray-200 text-sm italic">Convenience Store Management System</p>
            </div>
